package com.as.ignb.the_library.application;

import android.app.Application;
import android.widget.ImageView;

import com.as.ignb.the_library.base_utils.android_util_code.util.CrashManager;
import com.as.ignb.the_library.base_utils.android_util_code.util.Utils;
import com.as.ignb.the_library.DataBaseGD.MySQLiteOpenHelper;
...
//        daoSession = daoMaster.newSession();
        MySQLiteOpenHelper helper = new MySQLiteOpenHelper(this, "ignbuser.db",
                null);
        daoSession = new DaoMaster(helper.getEncryptedWritableDb("852780161")).newSession();
    }
